...
- [x] **Use of a CSS framework** - I used a variety of bootstrap elements in my project
- [x] **All visual elements styled using CSS** - I completed this part of the deliverable
- [x] **Responsive to window resizing using flexbox and/or grid display** - All pages are disigned for portrait/landscape/big and small displays.
...
- [x] **Hooks** - I completed part of the deliverable.
...
- [x] I completed the prerequisites for this deliverable (Simon deployed, GitHub link, Git commits)
- [x] **Stores data in MongoDB** - Database stores application information.
- [x] **Stores credentials in MongoDB** - Applications are connected to users in the database with proper credential information.
